    ...
    <div className="contact" id="contact">
      ...
      <div className="mediaBtn">
        ...
        <div className="mediaBtn">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href="https://mail.google.com/mail/?view=cm&source=mailto&to=neweraok360@gmail.com"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="40"
      ...
      <div className="footer">
        <div className="terminos">
          ...
          <h4>
            {" "}
            Utilizar esta web implica aceptar sus{" "}
            <a href="/#">Términos y condiciones</a>
          </h4>
          <h4>Empresa registrada en AAIP Argentina</h4>
        </div>
      </div>
    </div>
  );
